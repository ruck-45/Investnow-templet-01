...
export function Cards(props: cardsProps) {
  return (
    <>
      <div className="bg-yellow-200 h-[28rem] sm:h-auto md:h-[30rem] w-[70rem] flex flex-col md:flex-row gap-5 items-center justify-between  sm:p-[8rem] md:p-[10rem] lg:p-[5rem] sm:mx-[8rem] ">
