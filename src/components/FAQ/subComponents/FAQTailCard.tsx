...
const FAQTailCard = () => {
  return (
    <div
      className="Trading h-[30rem] bg-no-repeat bg-bottom bg-cover flex flex-col justify-center items-center gap-[1rem]"
    >
      <div className="flex flex-col items-center">
        <p className="text-white font-bold font-[Roboto] text-[3rem] leading-[3rem] text-center">
