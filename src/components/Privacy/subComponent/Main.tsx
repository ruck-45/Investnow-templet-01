...
const definations = [
  ...
  `Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to InvestNow.`,
  ...
  `Website refers to InvestNow, accessible from https://InvestNow.com/`,
...
const Main = () => {
  return (
    <div className="h-auto flex flex-col bg-white m-0 p-0 md:m-[2rem] md:p-[4rem] gap-4 rounded-lg">


      <div className="text-lg font-serif bg-white border-2 border-green-800 rounded-md p-[2rem] py-[1rem]">
        ...
        <Accordion className="mt-[1rem] " variant={undefined}>
        ...
        <Accordion className="  " variant={undefined}>
          <AccordionItem title="Policy for cancellation" subtitle={<span>Press to expand</span>} className="text-sm">
            <li className=" mx-[3rem]  ">
              {" "}
              The contract will be not effective between the service provider InvestNow and the client until received
              the full amount of payment from client.
            </li>
            <li className=" mx-[3rem]  ">The agency InvestNow has the right to take decision by reason for:-</li>
            ...
            <li className=" mx-[3rem]  ">
              ...
              other service provider agency apart from services officially confirmed by InvestNow also not be
              responsible for the sudden situations if arise within the service providing period by the agency InvestNow
              as damage , lost of luggage or any valuable goods, in the case of caused by the act or default of the
              management or employee of any hotelier, airline, surface transport, who are the agency’s independent
              service associates. <br />
              The InvestNow also not liable for situation arising out side of normal selection and inspection process,
              or acts of Government authority, war, civil or political disturbances, strike, natural calamities - as
            ...
            <li className=" mx-[3rem]  ">
              The agency InvestNow shall in no any circumstances whatsoever be liable to the client or persons traveling
              with the agency in the contract period of service provide for :-
            </li>
            <li className=" mx-[5rem]  ">
            ...
            <li className=" mx-[3rem]  ">
              ...
              The InvestNow reserves the right to amend the quoted rate in case of changes in any tax or surcharges
        ...
        <Accordion className="mt-[1rem]  " variant={undefined}>
          ...
          <AccordionItem title="Conditions Of Travel" subtitle={<span>Press to expand</span>}>
            {conditionsTravel.map((item, index) => (
              <li className=" mx-[3rem] text-sm font-normal" key={index}>
                {item}
              </li>
            ))}
          </AccordionItem>
