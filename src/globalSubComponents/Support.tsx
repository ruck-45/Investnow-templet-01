...
const Support = () => {
  return (
    <div className="p-[5rem] support flex flex-col justify-center items-center gap-[2rem]">
      <h1 className="font-[Roboto] text-[2.5rem] font-semibold">Enhance Your Experince</h1>
        ...
        {supportInfo.map((data, index) => (
          <Card isFooterBlurred radius="lg" className="border-none">
            <Image
              ...
              isZoomed
            />
            <CardFooter className="flex-col font-['Roboto'] text-center items-center before:bg-white/10 border-white/20 border-1 overflow-hidden py-1 absolute before:rounded-xl rounded-large bottom-1 w-[calc(100%_-_8px)] shadow-small ml-1 z-10 bg-[rgba(0,0,0,0.4)]">
